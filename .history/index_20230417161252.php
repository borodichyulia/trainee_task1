...
<body>
    ...
    function whetherNumberTernary(int $inputNumber)
    {
        ...
        $result = $inputNumber <= 10 ? $nameTask . "Equal or less than 10" : ($inputNumber > 10 && $inputNumber <= 20 ? $nameTask . "More than 10" : ($inputNumber > 20 && $inputNumber <= 30 ? $nameTask . "More than 20" : $nameTask . "More than 30"));
        $result;
    }
